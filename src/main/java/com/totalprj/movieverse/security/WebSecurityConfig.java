...
public class WebSecurityConfig implements WebMvcConfigurer {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/auth/**", "/ws/**", "/movies/**","/test/**","/email/**","/kakao/**","/ottbox/**","/otttiving/**","/ottnetflix/**","/ottwatcha/**","/category/**", "/", "/static/**").permitAll()
                .antMatchers("/v2/api-docs", "/swagger-resources/**", "/swagger-ui.html", "/webjars/**", "/swagger/**", "/sign-api/exception","/favicon.ico","/manifest.json").permitAll()
